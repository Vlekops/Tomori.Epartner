...
namespace Tomori.Epartner.API.Controllers
{
    public partial class PagePermissionController : BaseController<PagePermissionController>
    {
        ...
        {
            return Wrapper(await _mediator.Send(new GetPagePermissionByIdRequest() { Id = id }));
        }
        ...
        {
            return Wrapper(await _mediator.Send(new DeletePagePermissionRequest() { Id = id, Inputer = Inputer }));
        }
        ...
        {
            return Wrapper(await _mediator.Send(new ActivePagePermissionRequest() { Id = id, Active = value, Inputer = Inputer }));
        }
