...
namespace Tomori.Epartner.API.Controllers
{
    public partial class DocumentTemplateController : BaseController<DocumentTemplateController>
    {
        ...
        {
            return Wrapper(await _mediator.Send(new GetDocumentTemplateByIdRequest() { Id = id }), new { id });
        }
        ...
        {
            return Wrapper(await _mediator.Send(new ActiveDocumentTemplateRequest() { Id = id, Active = value, Token = Token.User }), new { id, value });
        }
