...
using Vleko.Result;
using Tomori.Epartner.Core.RolePermission.Query;
using Tomori.Epartner.Core.Request;
using Tomori.Epartner.Core.RolePermission.Command;
...
namespace Tomori.Epartner.API.Controllers
{
    public partial class RolePermissionController : BaseController<RolePermissionController>
    {
        ...
        {
            return Wrapper(await _mediator.Send(new GetRolePermissionByIdRequest() { Id = id }));
        }

        [HttpPost(template: "list")]
        public async Task<IActionResult> List([FromBody] ListRequest request)
        {
            var list_request = _mapper.Map<GetRolePermissionListRequest>(request);
        ...
        {
            return Wrapper(await _mediator.Send(new DeleteRolePermissionRequest() { Id = id, Inputer = Inputer }));
        }
