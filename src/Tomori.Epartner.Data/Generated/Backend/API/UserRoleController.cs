...
using Vleko.Result;
using Tomori.Epartner.Core.UserRole.Query;
using Tomori.Epartner.Core.Request;
using Tomori.Epartner.Core.UserRole.Command;
...
namespace Tomori.Epartner.API.Controllers
{
    public partial class UserRoleController : BaseController<UserRoleController>
    {
        ...
        {
            return Wrapper(await _mediator.Send(new GetUserRoleByIdRequest() { Id = id }), new { id });
        }
        ...
        {
            return Wrapper(await _mediator.Send(new DeleteUserRoleRequest() { Id = id, Token = Token.User }), new { id });
        }
