...
namespace Tomori.Epartner.API.Controllers
{
    public partial class RepositoryController : BaseController<RepositoryController>
    {
        ...
        {
            return Wrapper(await _mediator.Send(new GetRepositoryByIdRequest() { Id = id }));
        }
        ...
        public async Task<IActionResult> Add([FromBody] RepositoryRequest request)
        {
            var add_request = _mapper.Map<AddRepositoryRequest>(request);
        ...
        {
            var edit_request = _mapper.Map<EditRepositoryRequest>(request);
            edit_request.Id = id;
