...
namespace Tomori.Epartner.API.Controllers
{
    public partial class ChangeConfigController : BaseController<ChangeConfigController>
    {
        ...
        {
            return Wrapper(await _mediator.Send(new GetChangeConfigByIdRequest() { Id = id }));
        }

        [HttpPost(template: "list")]
        public async Task<IActionResult> List([FromBody] ListRequest request)
        {
            var list_request = _mapper.Map<GetChangeConfigListRequest>(request);
        ...
        {
            return Wrapper(await _mediator.Send(new DeleteChangeConfigRequest() { Id = id, Inputer = Inputer }));
        }
        ...
        {
            return Wrapper(await _mediator.Send(new ActiveChangeConfigRequest() { Id = id, Active = value, Inputer = Inputer }));
        }
