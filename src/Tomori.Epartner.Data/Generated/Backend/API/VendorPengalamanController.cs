...
=======
            return Wrapper(await _mediator.Send(new GetVendorPengalamanByIdRequest() { Id = id }), new { id });
>>>>>>> 5d5d61fd98f85493183e29a5767ce20080f32c00
        }
...
>>>>>>> 5d5d61fd98f85493183e29a5767ce20080f32c00
        ...
        {
<<<<<<< HEAD
            return Wrapper(await _mediator.Send(new DeleteVendorPengalamanRequest() { Id = id, Inputer = Inputer }));
=======
            return Wrapper(await _mediator.Send(new DeleteVendorPengalamanRequest() { Id = id, Token = Token.User }), new { id });
>>>>>>> 5d5d61fd98f85493183e29a5767ce20080f32c00
        }
