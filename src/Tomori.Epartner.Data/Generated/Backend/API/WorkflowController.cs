...
namespace Tomori.Epartner.API.Controllers
{
    public partial class WorkflowController : BaseController<WorkflowController>
    {
        ...
        {
            return Wrapper(await _mediator.Send(new GetWorkflowByIdRequest() { Id = id }));
        }
        ...
        {
            return Wrapper(await _mediator.Send(new DeleteWorkflowRequest() { Id = id, Inputer = Inputer }));
        }
