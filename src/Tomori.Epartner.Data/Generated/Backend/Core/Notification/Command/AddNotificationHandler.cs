...
namespace Tomori.Epartner.Core.Notification.Command
{
    ...
    public class AddNotificationRequest :NotificationRequest, IMapRequest<Tomori.Epartner.Data.Model.Notification, AddNotificationRequest>,IRequest<StatusResponse>
    {
        [Required]
        public TokenUserObject Token { get; set; }
        public void Mapping(IMappingExpression<AddNotificationRequest, Tomori.Epartner.Data.Model.Notification> map)
        {
    ...
    internal class AddNotificationHandler : IRequestHandler<AddNotificationRequest, StatusResponse>
    {
        ...
        public async Task<StatusResponse> Handle(AddNotificationRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var data = _mapper.Map<Tomori.Epartner.Data.Model.Notification>(request);
