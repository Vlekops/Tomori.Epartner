...
{
    public class GetVSusunanPengurusListRequest : ListRequest,IListRequest<GetVSusunanPengurusListRequest>,IRequest<ListResponse<VSusunanPengurusResponse>>
    {
    }
    internal class GetVSusunanPengurusListHandler : IRequestHandler<GetVSusunanPengurusListRequest, ListResponse<VSusunanPengurusResponse>>
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork<ApplicationDBContext> _context;
        public GetVSusunanPengurusListHandler(
            ILogger<GetVSusunanPengurusListHandler> logger,
            IMapper mapper,
        ...
        public async Task<ListResponse<VSusunanPengurusResponse>> Handle(GetVSusunanPengurusListRequest request, CancellationToken cancellationToken)
        {
            ListResponse<VSusunanPengurusResponse> result = new ListResponse<VSusunanPengurusResponse>();
            try
            {
				var query = _context.Entity<Tomori.Epartner.Data.Model.VSusunanPengurus>().AsQueryable();

				#region Filter
				Expression<Func<Tomori.Epartner.Data.Model.VSusunanPengurus, object>> column_sort = null;
				List<Expression<Func<Tomori.Epartner.Data.Model.VSusunanPengurus, bool>>> where = new List<Expression<Func<Tomori.Epartner.Data.Model.VSusunanPengurus, bool>>>();
				...
				result.List = _mapper.Map<List<VSusunanPengurusResponse>>(data_list);
            ...
            {
                _logger.LogError(ex, "Failed Get List VSusunanPengurus", request);
                result.Error("Failed Get List VSusunanPengurus", ex.Message);
            }
            return result;
        }

        #region List Utility
		private (Expression<Func<Tomori.Epartner.Data.Model.VSusunanPengurus, bool>> where, Expression<Func<Tomori.Epartner.Data.Model.VSusunanPengurus, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Tomori.Epartner.Data.Model.VSusunanPengurus, object>> result_order = null;
			Expression<Func<Tomori.Epartner.Data.Model.VSusunanPengurus, bool>> result_where = null;
