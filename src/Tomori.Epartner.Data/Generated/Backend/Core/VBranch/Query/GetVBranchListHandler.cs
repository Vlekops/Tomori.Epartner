...
{
    public class GetVBranchListRequest : ListRequest,IListRequest<GetVBranchListRequest>,IRequest<ListResponse<VBranchResponse>>
    {
    }
    internal class GetVBranchListHandler : IRequestHandler<GetVBranchListRequest, ListResponse<VBranchResponse>>
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork<ApplicationDBContext> _context;
        public GetVBranchListHandler(
            ILogger<GetVBranchListHandler> logger,
            IMapper mapper,
        ...
        public async Task<ListResponse<VBranchResponse>> Handle(GetVBranchListRequest request, CancellationToken cancellationToken)
        {
            ListResponse<VBranchResponse> result = new ListResponse<VBranchResponse>();
            try
            {
				var query = _context.Entity<Tomori.Epartner.Data.Model.VBranch>().AsQueryable();

				#region Filter
				Expression<Func<Tomori.Epartner.Data.Model.VBranch, object>> column_sort = null;
				List<Expression<Func<Tomori.Epartner.Data.Model.VBranch, bool>>> where = new List<Expression<Func<Tomori.Epartner.Data.Model.VBranch, bool>>>();
				...
				result.List = _mapper.Map<List<VBranchResponse>>(data_list);
            ...
            {
                _logger.LogError(ex, "Failed Get List VBranch", request);
                result.Error("Failed Get List VBranch", ex.Message);
            }
            return result;
        }

        #region List Utility
		private (Expression<Func<Tomori.Epartner.Data.Model.VBranch, bool>> where, Expression<Func<Tomori.Epartner.Data.Model.VBranch, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Tomori.Epartner.Data.Model.VBranch, object>> result_order = null;
			Expression<Func<Tomori.Epartner.Data.Model.VBranch, bool>> result_where = null;
