...
{
    public class GetVPajakListRequest : ListRequest,IListRequest<GetVPajakListRequest>,IRequest<ListResponse<VPajakResponse>>
    {
    }
    internal class GetVPajakListHandler : IRequestHandler<GetVPajakListRequest, ListResponse<VPajakResponse>>
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork<ApplicationDBContext> _context;
        public GetVPajakListHandler(
            ILogger<GetVPajakListHandler> logger,
            IMapper mapper,
        ...
        public async Task<ListResponse<VPajakResponse>> Handle(GetVPajakListRequest request, CancellationToken cancellationToken)
        {
            ListResponse<VPajakResponse> result = new ListResponse<VPajakResponse>();
            try
            {
				var query = _context.Entity<Tomori.Epartner.Data.Model.VPajak>().AsQueryable();

				#region Filter
				Expression<Func<Tomori.Epartner.Data.Model.VPajak, object>> column_sort = null;
				List<Expression<Func<Tomori.Epartner.Data.Model.VPajak, bool>>> where = new List<Expression<Func<Tomori.Epartner.Data.Model.VPajak, bool>>>();
				...
				result.List = _mapper.Map<List<VPajakResponse>>(data_list);
            ...
            {
                _logger.LogError(ex, "Failed Get List VPajak", request);
                result.Error("Failed Get List VPajak", ex.Message);
            }
            return result;
        }

        #region List Utility
		private (Expression<Func<Tomori.Epartner.Data.Model.VPajak, bool>> where, Expression<Func<Tomori.Epartner.Data.Model.VPajak, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Tomori.Epartner.Data.Model.VPajak, object>> result_order = null;
			Expression<Func<Tomori.Epartner.Data.Model.VPajak, bool>> result_where = null;
