...
{
    public class GetVNeracaListRequest : ListRequest,IListRequest<GetVNeracaListRequest>,IRequest<ListResponse<VNeracaResponse>>
    {
    }
    internal class GetVNeracaListHandler : IRequestHandler<GetVNeracaListRequest, ListResponse<VNeracaResponse>>
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork<ApplicationDBContext> _context;
        public GetVNeracaListHandler(
            ILogger<GetVNeracaListHandler> logger,
            IMapper mapper,
        ...
        public async Task<ListResponse<VNeracaResponse>> Handle(GetVNeracaListRequest request, CancellationToken cancellationToken)
        {
            ListResponse<VNeracaResponse> result = new ListResponse<VNeracaResponse>();
            try
            {
				var query = _context.Entity<Tomori.Epartner.Data.Model.VNeraca>().AsQueryable();

				#region Filter
				Expression<Func<Tomori.Epartner.Data.Model.VNeraca, object>> column_sort = null;
				List<Expression<Func<Tomori.Epartner.Data.Model.VNeraca, bool>>> where = new List<Expression<Func<Tomori.Epartner.Data.Model.VNeraca, bool>>>();
				...
				result.List = _mapper.Map<List<VNeracaResponse>>(data_list);
            ...
            {
                _logger.LogError(ex, "Failed Get List VNeraca", request);
                result.Error("Failed Get List VNeraca", ex.Message);
            }
            return result;
        }

        #region List Utility
		private (Expression<Func<Tomori.Epartner.Data.Model.VNeraca, bool>> where, Expression<Func<Tomori.Epartner.Data.Model.VNeraca, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Tomori.Epartner.Data.Model.VNeraca, object>> result_order = null;
			Expression<Func<Tomori.Epartner.Data.Model.VNeraca, bool>> result_where = null;
