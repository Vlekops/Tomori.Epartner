...
{
    public class GetVSpdaListRequest : ListRequest,IListRequest<GetVSpdaListRequest>,IRequest<ListResponse<VSpdaResponse>>
    {
    }
    internal class GetVSpdaListHandler : IRequestHandler<GetVSpdaListRequest, ListResponse<VSpdaResponse>>
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork<ApplicationDBContext> _context;
        public GetVSpdaListHandler(
            ILogger<GetVSpdaListHandler> logger,
            IMapper mapper,
        ...
        public async Task<ListResponse<VSpdaResponse>> Handle(GetVSpdaListRequest request, CancellationToken cancellationToken)
        {
            ListResponse<VSpdaResponse> result = new ListResponse<VSpdaResponse>();
            try
            {
				var query = _context.Entity<Tomori.Epartner.Data.Model.VSpda>().AsQueryable();

				#region Filter
				Expression<Func<Tomori.Epartner.Data.Model.VSpda, object>> column_sort = null;
				List<Expression<Func<Tomori.Epartner.Data.Model.VSpda, bool>>> where = new List<Expression<Func<Tomori.Epartner.Data.Model.VSpda, bool>>>();
				...
				result.List = _mapper.Map<List<VSpdaResponse>>(data_list);
            ...
            {
                _logger.LogError(ex, "Failed Get List VSpda", request);
                result.Error("Failed Get List VSpda", ex.Message);
            }
            return result;
        }

        #region List Utility
		private (Expression<Func<Tomori.Epartner.Data.Model.VSpda, bool>> where, Expression<Func<Tomori.Epartner.Data.Model.VSpda, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Tomori.Epartner.Data.Model.VSpda, object>> result_order = null;
			Expression<Func<Tomori.Epartner.Data.Model.VSpda, bool>> result_where = null;
