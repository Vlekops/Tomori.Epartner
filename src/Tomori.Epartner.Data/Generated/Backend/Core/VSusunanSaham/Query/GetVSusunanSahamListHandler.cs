...
{
    public class GetVSusunanSahamListRequest : ListRequest,IListRequest<GetVSusunanSahamListRequest>,IRequest<ListResponse<VSusunanSahamResponse>>
    {
    }
    internal class GetVSusunanSahamListHandler : IRequestHandler<GetVSusunanSahamListRequest, ListResponse<VSusunanSahamResponse>>
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork<ApplicationDBContext> _context;
        public GetVSusunanSahamListHandler(
            ILogger<GetVSusunanSahamListHandler> logger,
            IMapper mapper,
        ...
        public async Task<ListResponse<VSusunanSahamResponse>> Handle(GetVSusunanSahamListRequest request, CancellationToken cancellationToken)
        {
            ListResponse<VSusunanSahamResponse> result = new ListResponse<VSusunanSahamResponse>();
            try
            {
				var query = _context.Entity<Tomori.Epartner.Data.Model.VSusunanSaham>().AsQueryable();

				#region Filter
				Expression<Func<Tomori.Epartner.Data.Model.VSusunanSaham, object>> column_sort = null;
				List<Expression<Func<Tomori.Epartner.Data.Model.VSusunanSaham, bool>>> where = new List<Expression<Func<Tomori.Epartner.Data.Model.VSusunanSaham, bool>>>();
				...
				result.List = _mapper.Map<List<VSusunanSahamResponse>>(data_list);
            ...
            {
                _logger.LogError(ex, "Failed Get List VSusunanSaham", request);
                result.Error("Failed Get List VSusunanSaham", ex.Message);
            }
            return result;
        }

        #region List Utility
		private (Expression<Func<Tomori.Epartner.Data.Model.VSusunanSaham, bool>> where, Expression<Func<Tomori.Epartner.Data.Model.VSusunanSaham, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Tomori.Epartner.Data.Model.VSusunanSaham, object>> result_order = null;
			Expression<Func<Tomori.Epartner.Data.Model.VSusunanSaham, bool>> result_where = null;
