...
{
    public class GetChangeConfigListRequest : ListRequest,IListRequest<GetChangeConfigListRequest>,IRequest<ListResponse<ChangeConfigResponse>>
    {
    }
    internal class GetChangeConfigListHandler : IRequestHandler<GetChangeConfigListRequest, ListResponse<ChangeConfigResponse>>
    {
        ...
        public async Task<ListResponse<ChangeConfigResponse>> Handle(GetChangeConfigListRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
				var query = _context.Entity<Tomori.Epartner.Data.Model.ChangeConfig>().AsQueryable();

				#region Filter
				Expression<Func<Tomori.Epartner.Data.Model.ChangeConfig, object>> column_sort = null;
				List<Expression<Func<Tomori.Epartner.Data.Model.ChangeConfig, bool>>> where = new List<Expression<Func<Tomori.Epartner.Data.Model.ChangeConfig, bool>>>();
        ...
        #region List Utility
		private (Expression<Func<Tomori.Epartner.Data.Model.ChangeConfig, bool>> where, Expression<Func<Tomori.Epartner.Data.Model.ChangeConfig, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Tomori.Epartner.Data.Model.ChangeConfig, object>> result_order = null;
			Expression<Func<Tomori.Epartner.Data.Model.ChangeConfig, bool>> result_where = null;
            if (!string.IsNullOrWhiteSpace(search) && !string.IsNullOrWhiteSpace(field))
            {
                ...
                switch (field)
                {
					...
					case "field" : 
						if(is_where){
							result_where = (d=>d.Field.Trim().ToLower().Contains(search));
						}
						else
							result_order = (d => d.Field);
					break;
					case "modul" : 
						if(is_where){
