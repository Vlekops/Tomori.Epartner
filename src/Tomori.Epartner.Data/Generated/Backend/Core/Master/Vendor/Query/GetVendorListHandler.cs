...
namespace Tomori.Epartner.Core.Vendor.Query
{
    ...
    internal class GetVendorListHandler : IRequestHandler<GetVendorListRequest, ListResponse<VendorResponse>>
    {
        ...
        public async Task<ListResponse<VendorResponse>> Handle(GetVendorListRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
				var query = _context.Entity<Tomori.Epartner.Data.Model.MstVendor>().AsQueryable();

				#region Filter
				Expression<Func<Tomori.Epartner.Data.Model.MstVendor, object>> column_sort = null;
				List<Expression<Func<Tomori.Epartner.Data.Model.MstVendor, bool>>> where = new List<Expression<Func<Tomori.Epartner.Data.Model.MstVendor, bool>>>();
        ...
        #region List Utility
		private (Expression<Func<Tomori.Epartner.Data.Model.MstVendor, bool>> where, Expression<Func<Tomori.Epartner.Data.Model.MstVendor, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Tomori.Epartner.Data.Model.MstVendor, object>> result_order = null;
			Expression<Func<Tomori.Epartner.Data.Model.MstVendor, bool>> result_where = null;
