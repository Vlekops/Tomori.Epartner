...
namespace Tomori.Epartner.Core.VendorBranch.Query
{
    ...
    internal class GetVendorBranchListHandler : IRequestHandler<GetVendorBranchListRequest, ListResponse<VendorBranchResponse>>
    {
        ...
        public async Task<ListResponse<VendorBranchResponse>> Handle(GetVendorBranchListRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
				var query = _context.Entity<Tomori.Epartner.Data.Model.MstVendorBranch>().AsQueryable();

				#region Filter
				Expression<Func<Tomori.Epartner.Data.Model.MstVendorBranch, object>> column_sort = null;
				List<Expression<Func<Tomori.Epartner.Data.Model.MstVendorBranch, bool>>> where = new List<Expression<Func<Tomori.Epartner.Data.Model.MstVendorBranch, bool>>>();
        ...
        #region List Utility
		private (Expression<Func<Tomori.Epartner.Data.Model.MstVendorBranch, bool>> where, Expression<Func<Tomori.Epartner.Data.Model.MstVendorBranch, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Tomori.Epartner.Data.Model.MstVendorBranch, object>> result_order = null;
			Expression<Func<Tomori.Epartner.Data.Model.MstVendorBranch, bool>> result_where = null;
