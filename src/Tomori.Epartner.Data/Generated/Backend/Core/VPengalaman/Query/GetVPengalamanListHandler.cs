...
namespace Tomori.Epartner.Core.VPengalaman.Query
{
    public class GetVPengalamanListRequest : ListRequest,IListRequest<GetVPengalamanListRequest>,IRequest<ListResponse<VPengalamanResponse>>
    {
    }
    internal class GetVPengalamanListHandler : IRequestHandler<GetVPengalamanListRequest, ListResponse<VPengalamanResponse>>
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork<ApplicationDBContext> _context;
        public GetVPengalamanListHandler(
            ILogger<GetVPengalamanListHandler> logger,
            IMapper mapper,
        ...
        public async Task<ListResponse<VPengalamanResponse>> Handle(GetVPengalamanListRequest request, CancellationToken cancellationToken)
        {
            ListResponse<VPengalamanResponse> result = new ListResponse<VPengalamanResponse>();
            try
            {
				var query = _context.Entity<Tomori.Epartner.Data.Model.VPengalaman>().AsQueryable();

				#region Filter
				Expression<Func<Tomori.Epartner.Data.Model.VPengalaman, object>> column_sort = null;
				List<Expression<Func<Tomori.Epartner.Data.Model.VPengalaman, bool>>> where = new List<Expression<Func<Tomori.Epartner.Data.Model.VPengalaman, bool>>>();
				...
				result.List = _mapper.Map<List<VPengalamanResponse>>(data_list);
            ...
            {
                _logger.LogError(ex, "Failed Get List VPengalaman", request);
                result.Error("Failed Get List VPengalaman", ex.Message);
            }
            return result;
        }

        #region List Utility
		private (Expression<Func<Tomori.Epartner.Data.Model.VPengalaman, bool>> where, Expression<Func<Tomori.Epartner.Data.Model.VPengalaman, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Tomori.Epartner.Data.Model.VPengalaman, object>> result_order = null;
			Expression<Func<Tomori.Epartner.Data.Model.VPengalaman, bool>> result_where = null;
