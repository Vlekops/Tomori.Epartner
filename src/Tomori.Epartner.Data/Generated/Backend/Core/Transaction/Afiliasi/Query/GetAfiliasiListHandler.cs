...
{
    public class GetAfiliasiListRequest : ListRequest,IListRequest<GetAfiliasiListRequest>,IRequest<ListResponse<AfiliasiResponse>>
    {
    }
    internal class GetAfiliasiListHandler : IRequestHandler<GetAfiliasiListRequest, ListResponse<AfiliasiResponse>>
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork<ApplicationDBContext> _context;
        public GetAfiliasiListHandler(
            ILogger<GetAfiliasiListHandler> logger,
            IMapper mapper,
        ...
        public async Task<ListResponse<AfiliasiResponse>> Handle(GetAfiliasiListRequest request, CancellationToken cancellationToken)
        {
            ListResponse<AfiliasiResponse> result = new ListResponse<AfiliasiResponse>();
            try
            {
				var query = _context.Entity<Tomori.Epartner.Data.Model.TrsAfiliasi>().AsQueryable();

				#region Filter
				Expression<Func<Tomori.Epartner.Data.Model.TrsAfiliasi, object>> column_sort = null;
				List<Expression<Func<Tomori.Epartner.Data.Model.TrsAfiliasi, bool>>> where = new List<Expression<Func<Tomori.Epartner.Data.Model.TrsAfiliasi, bool>>>();
				...
				result.List = _mapper.Map<List<AfiliasiResponse>>(data_list);
            ...
            {
                _logger.LogError(ex, "Failed Get List Afiliasi", request);
                result.Error("Failed Get List Afiliasi", ex.Message);
            }
            return result;
        }

        #region List Utility
		private (Expression<Func<Tomori.Epartner.Data.Model.TrsAfiliasi, bool>> where, Expression<Func<Tomori.Epartner.Data.Model.TrsAfiliasi, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Tomori.Epartner.Data.Model.TrsAfiliasi, object>> result_order = null;
			Expression<Func<Tomori.Epartner.Data.Model.TrsAfiliasi, bool>> result_where = null;
