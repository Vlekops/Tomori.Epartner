...
{
    public class GetPengalamanListRequest : ListRequest,IListRequest<GetPengalamanListRequest>,IRequest<ListResponse<PengalamanResponse>>
    {
    }
    internal class GetPengalamanListHandler : IRequestHandler<GetPengalamanListRequest, ListResponse<PengalamanResponse>>
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork<ApplicationDBContext> _context;
        public GetPengalamanListHandler(
            ILogger<GetPengalamanListHandler> logger,
            IMapper mapper,
        ...
        public async Task<ListResponse<PengalamanResponse>> Handle(GetPengalamanListRequest request, CancellationToken cancellationToken)
        {
            ListResponse<PengalamanResponse> result = new ListResponse<PengalamanResponse>();
            try
            {
				var query = _context.Entity<Tomori.Epartner.Data.Model.TrsPengalaman>().AsQueryable();

				#region Filter
				Expression<Func<Tomori.Epartner.Data.Model.TrsPengalaman, object>> column_sort = null;
				List<Expression<Func<Tomori.Epartner.Data.Model.TrsPengalaman, bool>>> where = new List<Expression<Func<Tomori.Epartner.Data.Model.TrsPengalaman, bool>>>();
				...
				result.List = _mapper.Map<List<PengalamanResponse>>(data_list);
            ...
            {
                _logger.LogError(ex, "Failed Get List Pengalaman", request);
                result.Error("Failed Get List Pengalaman", ex.Message);
            }
            return result;
        }

        #region List Utility
		private (Expression<Func<Tomori.Epartner.Data.Model.TrsPengalaman, bool>> where, Expression<Func<Tomori.Epartner.Data.Model.TrsPengalaman, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Tomori.Epartner.Data.Model.TrsPengalaman, object>> result_order = null;
			Expression<Func<Tomori.Epartner.Data.Model.TrsPengalaman, bool>> result_where = null;
