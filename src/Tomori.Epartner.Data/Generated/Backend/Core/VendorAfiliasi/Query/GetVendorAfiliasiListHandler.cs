...
{
    public class GetVendorAfiliasiListRequest : ListRequest,IListRequest<GetVendorAfiliasiListRequest>,IRequest<ListResponse<VendorAfiliasiResponse>>
    {
    }
    internal class GetVendorAfiliasiListHandler : IRequestHandler<GetVendorAfiliasiListRequest, ListResponse<VendorAfiliasiResponse>>
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork<ApplicationDBContext> _context;
        public GetVendorAfiliasiListHandler(
            ILogger<GetVendorAfiliasiListHandler> logger,
            IMapper mapper,
        ...
        public async Task<ListResponse<VendorAfiliasiResponse>> Handle(GetVendorAfiliasiListRequest request, CancellationToken cancellationToken)
        {
            ListResponse<VendorAfiliasiResponse> result = new ListResponse<VendorAfiliasiResponse>();
            try
            {
				var query = _context.Entity<Tomori.Epartner.Data.Model.VendorAfiliasi>().AsQueryable();

				#region Filter
				Expression<Func<Tomori.Epartner.Data.Model.VendorAfiliasi, object>> column_sort = null;
				List<Expression<Func<Tomori.Epartner.Data.Model.VendorAfiliasi, bool>>> where = new List<Expression<Func<Tomori.Epartner.Data.Model.VendorAfiliasi, bool>>>();
				...
				result.List = _mapper.Map<List<VendorAfiliasiResponse>>(data_list);
            ...
            {
                _logger.LogError(ex, "Failed Get List VendorAfiliasi", request);
                result.Error("Failed Get List VendorAfiliasi", ex.Message);
            }
            return result;
        }

        #region List Utility
		private (Expression<Func<Tomori.Epartner.Data.Model.VendorAfiliasi, bool>> where, Expression<Func<Tomori.Epartner.Data.Model.VendorAfiliasi, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Tomori.Epartner.Data.Model.VendorAfiliasi, object>> result_order = null;
			Expression<Func<Tomori.Epartner.Data.Model.VendorAfiliasi, bool>> result_where = null;
