...
{
    public class GetVIzinUsahaListRequest : ListRequest,IListRequest<GetVIzinUsahaListRequest>,IRequest<ListResponse<VIzinUsahaResponse>>
    {
    }
    internal class GetVIzinUsahaListHandler : IRequestHandler<GetVIzinUsahaListRequest, ListResponse<VIzinUsahaResponse>>
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork<ApplicationDBContext> _context;
        public GetVIzinUsahaListHandler(
            ILogger<GetVIzinUsahaListHandler> logger,
            IMapper mapper,
        ...
        public async Task<ListResponse<VIzinUsahaResponse>> Handle(GetVIzinUsahaListRequest request, CancellationToken cancellationToken)
        {
            ListResponse<VIzinUsahaResponse> result = new ListResponse<VIzinUsahaResponse>();
            try
            {
				var query = _context.Entity<Tomori.Epartner.Data.Model.VIzinUsaha>().AsQueryable();

				#region Filter
				Expression<Func<Tomori.Epartner.Data.Model.VIzinUsaha, object>> column_sort = null;
				List<Expression<Func<Tomori.Epartner.Data.Model.VIzinUsaha, bool>>> where = new List<Expression<Func<Tomori.Epartner.Data.Model.VIzinUsaha, bool>>>();
				...
				result.List = _mapper.Map<List<VIzinUsahaResponse>>(data_list);
            ...
            {
                _logger.LogError(ex, "Failed Get List VIzinUsaha", request);
                result.Error("Failed Get List VIzinUsaha", ex.Message);
            }
            return result;
        }

        #region List Utility
		private (Expression<Func<Tomori.Epartner.Data.Model.VIzinUsaha, bool>> where, Expression<Func<Tomori.Epartner.Data.Model.VIzinUsaha, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Tomori.Epartner.Data.Model.VIzinUsaha, object>> result_order = null;
			Expression<Func<Tomori.Epartner.Data.Model.VIzinUsaha, bool>> result_where = null;
