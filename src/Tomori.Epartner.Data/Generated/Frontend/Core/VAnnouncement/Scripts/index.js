...
function getListVAnnouncement(page) {
    page = page != undefined ? page : 1;
    var pageSize = $('#VAnnouncement-page_select').val();
    var element = {
        table: '#VAnnouncement-table',
        tbody: '#VAnnouncement-tbody',
        from: '#VAnnouncement-from_page',
        to: '#VAnnouncement-to_page',
        total: '#VAnnouncement-total',
        pagination: '#VAnnouncement-pagination',
        item_pagination: 'VAnnouncement-item'
    }
    var param = {
        sort: {
            field: "id",
    ...
    RequestData('POST', "/v1/VAnnouncement/list", element.table, element.tbody, JSON.stringify(param), function (data) {
        if (data.succeeded) {
            $(element.tbody).html('');
            ...
            if (data.list.length > 0) {
                SetTableData(true, 12, element, {
                    ...
                    pageSize: pageSize,
                    count: data.count,
                    function_name: 'getListVAnnouncement'
                }, function (count) {
                                ...
                                <td class="text-center">
                                    <div>
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="#!" class="dropdown-item" onclick="detailVAnnouncementDialog(this);" data-detail='${JSON.stringify(item).replace(/' /g, " " ) }'>Detail</a>
                                            <a href="#!" class="dropdown-item" onclick="editVAnnouncementDialog(this);" data-detail='${JSON.stringify(item).replace(/' /g, " " ) }'>Edit</a>
                                            <a href="#!" class="dropdown-item" onclick="deleteVAnnouncementDialog(${item.id})">Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
