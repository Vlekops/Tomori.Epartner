...
function getListPengalaman(page) {
    page = page != undefined ? page : 1;
    var pageSize = $('#Pengalaman-page_select').val();
    var element = {
        table: '#Pengalaman-table',
        tbody: '#Pengalaman-tbody',
        from: '#Pengalaman-from_page',
        to: '#Pengalaman-to_page',
        total: '#Pengalaman-total',
        pagination: '#Pengalaman-pagination',
        item_pagination: 'Pengalaman-item'
    }
    var param = {
        sort: {
            field: "id",
    ...
    RequestData('POST', "/v1/Pengalaman/list", element.table, element.tbody, JSON.stringify(param), function (data) {
        if (data.succeeded) {
            $(element.tbody).html('');
            ...
            if (data.list.length > 0) {
                SetTableData(true, 12, element, {
                    ...
                    pageSize: pageSize,
                    count: data.count,
                    function_name: 'getListPengalaman'
                }, function (count) {
                                ...
                                <td class="text-center">
                                    <div>
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="#!" class="dropdown-item" onclick="detailPengalamanDialog(this);" data-detail='${JSON.stringify(item).replace(/' /g, " " ) }'>Detail</a>
                                            <a href="#!" class="dropdown-item" onclick="editPengalamanDialog(this);" data-detail='${JSON.stringify(item).replace(/' /g, " " ) }'>Edit</a>
                                            <a href="#!" class="dropdown-item" onclick="deletePengalamanDialog(${item.id})">Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
