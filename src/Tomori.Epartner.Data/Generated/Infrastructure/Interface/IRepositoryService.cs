...
namespace Tomori.Epartner.Web.Component.Services
{
    ...
    {
        Task<ObjectResponse<RepositoryResponse>> Get(Guid id, string baseUrl, string token);
        Task<ListResponse<RepositoryResponse>> List(ListRequest request, string baseUrl, string token);
        Task<StatusResponse> Add(RepositoryRequest request, string baseUrl, string token);
