...
namespace Tomori.Epartner.API.Controllers
{
    public partial class VendorAfiliasiController : BaseController<VendorAfiliasiController>
    {
        ...
        {
            return Wrapper(await _mediator.Send(new GetVendorAfiliasiByIdRequest() { Id = id }));
        }
        ...
        {
            return Wrapper(await _mediator.Send(new DeleteVendorAfiliasiRequest() { Id = id, Inputer = Token.User.Username }));
        }
