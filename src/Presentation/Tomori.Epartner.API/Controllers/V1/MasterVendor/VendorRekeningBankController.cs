...
namespace Tomori.Epartner.API.Controllers
{
    public partial class VendorRekeningBankController : BaseController<VendorRekeningBankController>
    {
        ...
        {
            return Wrapper(await _mediator.Send(new GetVendorRekeningBankByIdRequest() { Id = id }));
        }
        ...
        {
            return Wrapper(await _mediator.Send(new DeleteVendorRekeningBankRequest() { Id = id, Inputer = Token.User.Username }));
        }
