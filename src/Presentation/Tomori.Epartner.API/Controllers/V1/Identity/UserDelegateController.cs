...
using Vleko.Result;
using Tomori.Epartner.Core.Identity.UserDelegate.Query;
using Tomori.Epartner.Core.Identity.Request;
using Tomori.Epartner.Core.Identity.UserDelegate.Command;
...
namespace Tomori.Epartner.API.Controllers
{
    public partial class UserDelegateController : BaseController<UserDelegateController>
    {
        ...
        {
            return Wrapper(await _mediator.Send(new GetUserDelegateByIdRequest() { Id = id }), new { id });
        }
        ...
        {
            return Wrapper(await _mediator.Send(new DeleteUserDelegateRequest() { Id = id, Token = Token.User }), new { id });
        }
