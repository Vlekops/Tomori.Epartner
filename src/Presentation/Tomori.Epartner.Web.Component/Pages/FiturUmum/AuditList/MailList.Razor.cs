...
{
    public partial class MailList : ComponentBase
    {
        #region Override
        ...
        #region field
        private MudDataGrid<TableRowWrapper<MailLogResponse>> _Table;
        ...
        #region Method
        private async Task<GridData<TableRowWrapper<MailLogResponse>>> GetDataTable(GridState<TableRowWrapper<MailLogResponse>> state)
        {
            var result = new GridData<TableRowWrapper<MailLogResponse>>
            {
                Items = new List<TableRowWrapper<MailLogResponse>>(),
                TotalItems = 0
            };
            ...
            try
            {
                ...
                var res = await _LogService.MailList(param, Token.BaseApiUrl, Token.RawToken);
