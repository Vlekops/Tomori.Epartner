...
namespace Tomori.Epartner.Web.Component.Pages.FiturUmum.AuditList
{
    public partial class ActivityList : ComponentBase
    {
        ...
        #region field
        private MudDataGrid<TableRowWrapper<ActivityLogResponse>> _Table;
        ...
        #region Method
        private async Task<GridData<TableRowWrapper<ActivityLogResponse>>> GetDataTable(GridState<TableRowWrapper<ActivityLogResponse>> state)
        {
            var result = new GridData<TableRowWrapper<ActivityLogResponse>>
            {
                Items = new List<TableRowWrapper<ActivityLogResponse>>(),
                TotalItems = 0
            };
            ...
            try
            {
                ...
                var res = await _LogService.ActivityList(param, Token.BaseApiUrl, Token.RawToken);
