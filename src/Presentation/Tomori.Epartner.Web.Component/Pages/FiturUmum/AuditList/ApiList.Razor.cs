...
namespace Tomori.Epartner.Web.Component.Pages.FiturUmum.AuditList
{
    public partial class ApiList : ComponentBase
    {
        ...
        #region field
        private MudDataGrid<TableRowWrapper<ApiLogResponse>> _Table;
        ...
        #region Method
        private async Task<GridData<TableRowWrapper<ApiLogResponse>>> GetDataTable(GridState<TableRowWrapper<ApiLogResponse>> state)
        {
            var result = new GridData<TableRowWrapper<ApiLogResponse>>
            {
                Items = new List<TableRowWrapper<ApiLogResponse>>(),
                TotalItems = 0
            };
            ...
            try
            {
                ...
                var res = await _LogService.ApiList(param, Token.BaseApiUrl, Token.RawToken);
