using Tomori.Epartner.Web.Component.Pages.FiturUmum.AuditList.Dialog;
...
{
    public partial class ChangeList : ComponentBase
    {
        #region Override
        ...
        #region field
        private MudDataGrid<TableRowWrapper<ChangeLogResponse>> _Table;
        ...
        #region Method
        private async Task<GridData<TableRowWrapper<ChangeLogResponse>>> GetDataTable(GridState<TableRowWrapper<ChangeLogResponse>> state)
        {
            var result = new GridData<TableRowWrapper<ChangeLogResponse>>
            {
                Items = new List<TableRowWrapper<ChangeLogResponse>>(),
                TotalItems = 0
            };
            ...
            try
            {
                ...
                var res = await _LogService.ChangeList(param, Token.BaseApiUrl, Token.RawToken);
        ...
        private void Detail(List<ChangeLogPropertyResponse> listProperties)
        {
            ...
            _DialogService.Show<DialogDetailChangeLog>("Detail Change Log", paramDialog, new DialogOptions { MaxWidth = MaxWidth.ExtraLarge });
        }
