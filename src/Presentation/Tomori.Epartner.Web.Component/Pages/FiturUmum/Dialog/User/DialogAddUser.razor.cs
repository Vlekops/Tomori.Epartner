...
{
    public partial class DialogAddUser : ComponentBase
    {
        #region Override
        ...
        private async Task Save()
        {
            ...
            try
            {
                var param = new RegisterUserRequest
                {
                    Mail = _Mail,
                    Fullname = _Fullname,
                ...
                StatusResponse res = await _UserService.Add(param, Token.BaseApiUrl, Token.RawToken);
