...
{
    #region Request
    public class ExportCsvRequest : IRequest<ObjectResponse<FileObject>>
    {
        [Required]
    ...
    internal class ExportCsvHandler : IRequestHandler<ExportCsvRequest, ObjectResponse<FileObject>>
    {
        ...
        public async Task<ObjectResponse<FileObject>> Handle(ExportCsvRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                string filename = $@"{data_report.Name.Replace(" ", "_")}_report_{DateTime.Now.ToString("DD_MM_YYYY")}.csv";
